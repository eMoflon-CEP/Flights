 ...
 * </p>
 * <ul>
 *   <li>{@link Flights.impl.TimeStampImpl#getTime <em>Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeStampImpl extends MinimalEObjectImpl.Container implements TimeStamp {
	...
	protected EClass eStaticClass() {
		return FlightsPackage.Literals.TIME_STAMP;
	}
	...
	public void setTime(long newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlightsPackage.TIME_STAMP__TIME, oldTime, time));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case FlightsPackage.TIME_STAMP__TIME:
			return getTime();
		}
