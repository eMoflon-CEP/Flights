 ...
 * </p>
 * <ul>
 *   <li>{@link Flights.impl.PersonsImpl#getPersons <em>Persons</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonsImpl extends MinimalEObjectImpl.Container implements Persons {
	...
	protected EClass eStaticClass() {
		return FlightsPackage.Literals.PERSONS;
	}
	...
	public EList<Person> getPersons() {
		if (persons == null) {
			persons = new EObjectContainmentEList<Person>(Person.class, this, FlightsPackage.PERSONS__PERSONS);
		}
		return persons;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case FlightsPackage.PERSONS__PERSONS:
